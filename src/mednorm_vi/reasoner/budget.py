...
inference. Qwen3-8B fits beside E3; it does **not** fit beside the Audit-0073 embedding and
...
def assert_within_cap(*, with_semantic_s1: bool = False) -> int:
    ...
    if total >= PARAMETER_CAP:
        raise ParameterBudgetExceeded(
            ...
            "Qwen3-8B and the Audit-0073 Embedding-4B/Reranker-4B pair cannot co-deploy; "
