...
from mednorm_vi.extraction import aliases as ca  # noqa: E402
from mednorm_vi.extraction import alignment as cd  # noqa: E402
from mednorm_vi.extraction import assertions as cs  # noqa: E402
from mednorm_vi.extraction import lattice as cl  # noqa: E402
from mednorm_vi.extraction import proposer as cp  # noqa: E402
from mednorm_vi.extraction import resolver as cr  # noqa: E402
from mednorm_vi.extraction import runtime as crt  # noqa: E402
from mednorm_vi.extraction import verifier as cv  # noqa: E402
from mednorm_vi.extraction.proposals import (  # noqa: E402
    SOURCE_ALIAS,
    SOURCE_E3,
    SOURCE_QWEN,
    Proposal,
...
def test_no_stub_markers_in_the_0081_production_path() -> None:
    ...
    paths = [
        *sorted((ROOT / "src/mednorm_vi/extraction").glob("*.py")),
        CLI_PATH,
    ]
    for path in paths:
